...
?>
						...
						<div class="post_wrapper">
							...
							*/
							...
							<div class="post_header_wrapper single">
								...
								Por <?php echo get_the_author(); ?> | <?php echo get_the_time('d - M - Y h:m'); ?> | <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php comments_number('Sin comentarios', '1 comentario', '% comentarios'); ?></a>
								</div>
							</div>
						...
						<h2 class="widgettitle">Escrito por <?php the_author_link(); ?></h2>
						...
						if ($tags) {
						  ...
						  if( $my_query->have_posts() ) {
						  	echo '<h2 class="widgettitle">Art&iacute;culos Relaccionados</h2><br class="clear"/>';
						 ?>
						 ...
						 ?>
						    <div class="each_item">
						    	...
						    	<div class="content">
						    		...
						    		<br/>
									<span class="post_attribute"><?php echo get_the_time('j - F - Y', $post->ID); ?></span>
						      	</div>
							</div>
						  <?php
								endwhile;
						...
						<div class="sidebar">
							...
							<div class="content">
								...
								<ul class="sidebar_widget">
									<?php // ESTA ERA LA ORIGINAL dynamic_sidebar('Single Post Sidebar'); ?>
