			...
			<div class="inner">
				...
				<div class="inner_wrapper">
					...
					<div class="sidebar_content">
						...
						<?php printf( __( 'Archivo / %s', THEMEDOMAIN ), get_the_date() ); ?>
		<?php elseif ( is_month() ) : ?>
						<?php printf( __( 'Archivo / %s', THEMEDOMAIN ), get_the_date('F Y') ); ?>
		<?php elseif ( is_year() ) : ?>
						<?php printf( __( 'Archivo / %s', THEMEDOMAIN ), get_the_date('Y') ); ?>
		<?php else : ?>
						<?php _e( 'Archivo del Blog', THEMEDOMAIN ); ?>
		<?php endif; ?></h2>
