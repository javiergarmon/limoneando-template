    ...
    <div class="post_wrapper half<?php if($count%2==0) { ?> last<?php } ?>" <?php if(empty($featured_posts_arr) && $count<3) { ?>style="margin-top:15px;"<?php } ?>>
    	...
    	<div class="post_img">
    		<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
    			<img src="<?php echo $image_thumb[0]; ?>" alt="" class="" style="width:290px;height:180px"/>
    		</a>
    	...
    	<div class="post_header_wrapper half">
    		...
    		<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php comments_number('¡Se el primero en comentar!', '1 comentario', '% comentarios'); ?></a>
    		</div>
    	</div>
