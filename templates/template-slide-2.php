 ...
 <?php
 		foreach($featured_posts_arr as $key => $featured_post)
 		{
 			...
 			if(has_post_thumbnail($featured_post->ID, 'home_full_ft'))
 			{
    			...
    			$thumb_url = wp_get_attachment_image_src($image_id, 'home_full_ft_thumb', true);
 ?>
 				<a href="<?php echo $hyperlink_url;?>">
 					<img src="<?php echo $image_url[0]; ?>" style="width:905px;height:400px" alt="#caption<?php echo $key; ?>" rel="<?php echo $thumb_url[0]; ?>"/>
 				</a>
 <?php
 			}
 			else
    ...
    ?>
    		    <a href="<?php echo $hyperlink_url;?>">
    		    	<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/trans_000_bg.png" style="width:905px;height:400px" alt="#caption<?php echo $key; ?>" rel="<?php echo get_stylesheet_directory_uri(); ?>/images/trans_000_bg.png"/>
    		    </a>
    <?php
    		}
 		}
